...
ЛИШНИЕ слайды (ПРОПУСКАЙ их, НЕ назначай никуда):
...
4. Все остальные слайды (таймеры, будильники, юмор) — ПРОПУСКАЙ.
...
- Лишние слайды (таймеры, будильники, юмор) НЕ назначай — просто пропусти.
`.trim();
}
